...
EOF
onsighup()  { ./cups.py -r 0 -s 0 -d xxx message "SIGHUP" --sighup }
onsigint()  { ./cups.py -r 0 -s 0 -d xxx message "SIGINT" --sigint }
onsigkill() { ./cups.py -r 0 -s 0 -d xxx message "SIGKILL" --sigkill }
onsigpipe() { ./cups.py -r 0 -s 0 -d xxx message "SIGPIPE" --sigpipe }
onsigusr1() { ./cups.py -r 0 -s 0 -d xxx message "SIGUSR1" --sigusr1 }
onsigusr2() { ./cups.py -r 0 -s 0 -d xxx message "SIGUSR2" --sigusr2 }
